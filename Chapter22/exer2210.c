...
// become full, for example). Show how to add the missing error check to the program,
// assuming that we want it to display a message and terminate immediately if an error occurs.
